...
def generate_pdf(summary, agent_outputs):
    ...
    elements.append(Paragraph("Explore • Experience • Enjoy", styles['CoverFooter']))
    elements.append(PageBreak())
    
    # --- CONTENT ---

    section_map = {
        "Booking Suggestions": "✈️ Flights & Logistics",
        "Stay Options": "🏨 Accommodation",
        "Experiences": "🎨 Experiences & Activities",
        "Local Food & Dining": "🍽️ Culinary Delights",
        "Travel Logistics": "🚗 Local Transport",
        "Budget Planning": "💰 Estimated Budget"
    }
...
def plan_trip():
    try:
        ...
        # Save email_sent status to the trip record
        new_trip.email_sent = email_sent
        db.session.commit()
